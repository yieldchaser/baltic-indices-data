...
- grain
date: null
doc_id: baltic_dry_unknown_2016_bulk_report_week62016_dry
...
summary: 'Capesize
  ...
  somewhat by the end, levels are still dire. Minimal changes across all the routes
  with the two main ore voyages from Brazil and west Australia closing at a few cents
  under where the levels were last week. Currently Tubarao rates are fixing around
  the $5.75 level and $2.85 seems to be the conference rate for loading West Australia.'
themes:
- capesize
- panamax
- supramax
...
## Summary
Capesize
The market was dormant for the first half of the week and while it had woken up somewhat by the end, levels are still dire. Minimal changes across all the routes with the two main ore voyages from Brazil and west Australia closing at a few cents under where the levels were last week. Currently Tubarao rates are fixing around the $5.75 level and $2.85 seems to be the conference rate for loading West Australia.
...
There was a knock on effect to the Atlantic with brokers struggling to find firm business to fix. The BDI at last stopped going down on Thursday 11 th February but only managed to be unchanged at an all-time low of ‘290'.
