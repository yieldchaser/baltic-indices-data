...
- grain
date: null
doc_id: baltic_dry_unknown_2015_market_endures_panamaxshockduringdifficultwee_dry
...
summary: 'Capesize
  ...
  and in the Atlantic. Too many ships in the East continued to weigh on the market
  and although some of the majors have been taking ships for West Australia, each
  has been at successively lower rates. As the week closed out the West Australia/Qingdao
  rate stood at $4.15 for 170,000-tonnes 10% for 11 February eta.'
themes:
- capesize
- panamax
- supramax
...
- china
- brazil
title: Market endures panamax shock during difficult week
vessel_classes:
- capesize
- panamax
- supramax
