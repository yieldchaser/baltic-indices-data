...
- grain
date: null
doc_id: baltic_dry_unknown_2015_slight_peaks_andtroughsforcapesizes_dry
...
summary: 'Capesize
  ...
  In the East the majors were again in the market for West Australia/China cargoes
  and rates climbed off the lows. Rates rose to $4.85 for February 170,000 tonne 10%
  cargoes from Dampier to Qingdao, but today there were reports that $4.50 has now
  been done.'
themes:
- capesize
- panamax
...
- china
- brazil
title: Slight peaks and troughs for capesizes
vessel_classes:
- capesize
- panamax
- supramax
