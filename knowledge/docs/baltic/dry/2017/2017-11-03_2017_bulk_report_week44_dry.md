...
- grain
date: '2017-11-03'
doc_id: baltic_dry_2017-11-03_2017_bulk_report_week44_dry
...
summary: 'Capesize
  ...
  reasonable balance. For the west Australia to China run, the market has slipped
  to around US$7.50 from last week''s levels in the low US$8s. Brazil to China has
  remained around the US$17.50 level with this rate fixed by SwissMarine on the Kyla
  Fortune and the newcastlemax - Kachodoki achieving a similar rate from Cargill for
  a full cargo.'
themes:
- capesize
- panamax
