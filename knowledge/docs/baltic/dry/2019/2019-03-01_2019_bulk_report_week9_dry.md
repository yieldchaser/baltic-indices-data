...
- crude_oil
date: '2019-03-01'
doc_id: baltic_dry_2019-03-01_2019_bulk_report_week9_dry
...
summary: 'Capesize
  ...
  impact on sentiment, with rates falling in all areas. There were operators still
  shipping from Brazil, with the rate from Tubarao to China hovering around the mid
  $12.00s for end March. Rates for Brazil/Continent runs also slumped, with a 180,000-tonne,
  10% cargo, fixed from Itaguai to Rotterdam at $4.50 for 26-29 March.'
themes:
- capesize
- panamax
- supramax
