...
- products
date: null
doc_id: baltic_tanker_unknown_2015_vlcc_tonnage_buildingwhilesuezmaxratesclimb_tanker
...
summary: 'VLCCs
  ...
  have been under pressure. In the last month it seems over 30 vessels have fixed
  on timecharter basis for various short to long term periods, with some now being
  marketed on the spot market. Although levels of WS 69/69.5 were reported paid for
  270,000 tonnes to Singapore/China respectively, subsequent tonnage has shown a willingness
  to conclude at WS 65, but some say the owners may struggle to achieve even this
  level.'
themes:
- capesize
- panamax
...
- aframax
- china
title: VLCC tonnage building, while suezmax rates climb
vessel_classes:
- vlcc
- suezmax
- aframax
