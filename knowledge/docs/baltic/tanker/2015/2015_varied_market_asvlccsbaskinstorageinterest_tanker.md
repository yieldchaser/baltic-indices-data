...
- products
date: null
doc_id: baltic_tanker_unknown_2015_varied_market_asvlccsbaskinstorageinterest_tanker
...
summary: 'VLCCs
  ...
  to South Korea/China. For trades going west Bahri managed to cover 280,000 tonnes
  to the US Gulf on two ships early this week at WS 35/36 (cape/cape basis), but later
  in the week Litasco reportedly took Athenian tonnage from Basrah for west options
  only at WS 42 (cape/cape), although they would have paid some premium for the options.
  The owners'' cause is still being helped by ongoing storage interest with rates
  varying from $42,500 daily to rumoured high $40,000s.'
themes:
- capesize
- panamax
- vlcc
...
- aframax
- china
title: Varied market as VLCCs bask in storage interest
vessel_classes:
- vlcc
- suezmax
- aframax
