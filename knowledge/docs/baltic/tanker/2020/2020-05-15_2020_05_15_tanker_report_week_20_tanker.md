...
- products
date: '2020-05-15'
doc_id: baltic_tanker_2020-05-15_2020_05_15_tanker_report_week_20_tanker
...
summary: 'VLCC
  ...
  towards covering the balance of May cargoes. Next month will see fewer fixtures
  as there will be less cargoes due to the OPEC+ cuts, with reports of one charterer
  getting a third of their requested stems from Saudi Arabia - and the Kuwaitis reported
  to be aiming for their contractual minimums. Owners this week have managed to maintain
  rates, with 270,000mt to China at WS59 level, while 280,000mt to USG via the cape/cape
  routing remaining at just under WS35.'
themes:
- capesize
- vlcc
- suezmax
