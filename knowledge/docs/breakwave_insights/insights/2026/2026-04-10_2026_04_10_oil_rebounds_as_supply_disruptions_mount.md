...
- section: Main
  section_type: null
  source_line: Crude oil futures rebounded as the US-Iran ceasefire failed to allay
    fears of further supply disruptions. The Strait of Hormuz remained largely blocked
    on Wednesday, despite its reopening being a key part of the agreement. Just three
    ships were observed leavin
  unit: null
  values:
  - 800.0
  - 600.0
...
- section: Main
  section_type: null
  source_line: 'Even if the Strait of Hormuz is reopened, it will take some time for
    supplies to reach the international market. We expect that only partial recovery
    is feasible in the near term. At best 2-3mb/d could return within the first month,
    largely via the restart of '
  unit: null
  values:
  - 2.0
  - -3.0
...
- section: Main
  section_type: null
  source_line: Global gas prices tracked oil higher as supply disruptions persisted.
    European gas futures rose by nearly 2%, while North Asia LNG prices nudged higher.
    LNG tankers remain stuck in the Persian Gulf, with no end in sight to the impasse.
...
- section: Main
  section_type: null
  source_line: Gold advanced for a third day despite tensions threatening to derail
    the ceasefire deal in the Middle East. Investors are encouraged by reports that
    peace talks between US and Iran will go ahead in Pakistan later this week. Positive
    economic data also eased co
  unit: null
  values:
  - 70.0
  - 27.0
...
source_path: reports/breakwave/2026/2026-04-10_oil-rebounds-as-supply-disruptions-mount.html
source_stem: 2026-04-10_oil-rebounds-as-supply-disruptions-mount
source_url: https://www.breakwaveadvisors.com/insights/2026/4/10/oil-rebounds-as-supply-disruptions-mount
summary: 'Main

  By Daniel Hynes

  Crude oil futures rebounded as the US-Iran ceasefire failed to allay fears of further
  supply disruptions. The Strait of Hormuz remained largely blocked on Wednesday,
  despite its reopening being a key part of the agreement. Just three ships were observed
  leaving the region on Wednesday, according to Bloomberg ship tracking data.'
themes:
- lng
- australia
- europe
...
- grain
- crude_oil
title: Oil rebounds as supply disruptions mount
vessel_classes:
- capesize
- panamax
- supramax
...
Main
By Daniel Hynes
Crude oil futures rebounded as the US-Iran ceasefire failed to allay fears of further supply disruptions. The Strait of Hormuz remained largely blocked on Wednesday, despite its reopening being a key part of the agreement. Just three ships were observed leaving the region on Wednesday, according to Bloomberg ship tracking data.
