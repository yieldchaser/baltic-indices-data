...
- gas
date: '2022-10-12'
doc_id: breakwave_insights_insights_2022-10-12_2022_10_12_eu_shipping_ban_to_be_the_deciding_factor_for_russia_volumes
...
source_path: reports/breakwave/2022/2022-10-12_eu-shipping-ban-to-be-the-deciding-factor-for-russia-volumes.html
source_stem: 2022-10-12_eu-shipping-ban-to-be-the-deciding-factor-for-russia-volumes
source_url: https://www.breakwaveadvisors.com/insights/2022/10/12/eu-shipping-ban-to-be-the-deciding-factor-for-russia-volumes-and-tanker-fates
summary: 'Main

  By Ioannis Papadimitriou

  With the EU ban on Russian crude and products just round the corner, the unwinding
  of the Russian-European oil interdependency is underway. For crude barrels this
  has been the case for quite a while, with Europe managing to reduce its Russian
  crude purchases significantly. Yet for clean products (CPP) the change in trade
  patterns has just commenced.'
themes:
- europe
- india
- grain
...
- products
- russia
title: Eu Shipping Ban To Be The Deciding Factor For Russia Volumes And Tanker Fates
vessel_classes:
- capesize
- panamax
- supramax
...
It is also evident that the reshuffling is in full swing from both sides. Europe has commenced sourcing greater volumes of diesel from regions such as the US and the Middle East , while Russia has started raising its CPP exposure to outlets outside of the EU, the G7 as well as OECD Asia, as displayed below:
Arrivals of Russian oil products in "friendly" markets (excl. G7, EU and OECD Asia, mbd)
In this insight we will focus on how recent developments affect Russia from a freight lens, and attempt to answer two questions:
What is the incremental CPP tanker demand that can be generated by the redirected trade flows out of Russia?
How (and if) Russia would be able to cope with a prospective EU shipping insurance ban to carry Russian oil and products to third-party countries?
