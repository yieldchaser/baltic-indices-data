...
- gas
date: '2023-06-13'
doc_id: breakwave_insights_insights_2023-06-13_2023_06_13_mazars_comment_to_hike_or_not_to_hike_that_is_definitively_not_the_question
...
source_path: reports/breakwave/2023/2023-06-13_mazars-comment-to-hike-or-not-to-hike-that-is-definitively-not-the-question.html
source_stem: 2023-06-13_mazars-comment-to-hike-or-not-to-hike-that-is-definitively-not-the-question
source_url: https://www.breakwaveadvisors.com/insights/2023/6/13/mazars-comment-to-hike-or-not-to-hike-that-is-definitively-not-the-question
summary: "Main\n\uFEFF\nBy George Lagarias\nThe three things I would tell my clients
  this week:\nThe Fed will probably pause rate hikes, for now. This doesn't necessarily
  mean that it has stopped hiking. Nor that it will cut anytime soon."
themes:
- crude_oil
- are
- hike
...
- credit
- fed
title: 'Mazars Comment : To hike or not to hike. That is definitively NOT the question'
vessel_classes:
- capesize
- panamax
- supramax
...
The Fed will probably pause rate hikes, for now. This doesn't necessarily mean that it has stopped hiking. Nor that it will cut anytime soon.
...
The three things I would tell my clients this week:
The Fed will probably pause rate hikes, for now. This doesn't necessarily mean that it has stopped hiking. Nor that it will cut anytime soon.
Whether the Fed will pause, or slightly hike further is irrelevant. Money supply is the tightest it has been for years, and will most likely continue to tighten further in the next few months, even if the central bank doesn't produce another rate hike in this cycle.
The question isn't whether rates will tighten a bit more. The question is how many investors, businesses and consumers are really ready for a credit crunch.
...
Shakespeare is great for philosophy. However, as a Greek, I'll let you in on a little secret about philosophy. Most of it is about abstract, non-real life dilemmas, mostly a play on words. Schrodinger's cat is perfectly alive, until we decide it isn't. Achilles will simply outrun the tortoise. The Ship of Theseus gets the same number of visitors whether the planks are new or old.
These "thought experiments" are no more than a simple illustration that languages and mathematics are flawed. And most try to boil complex situations down to binary outcomes.
